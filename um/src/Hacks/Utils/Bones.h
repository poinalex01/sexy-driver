...
uintptr_t GetBoneMatrix(uintptr_t entityPawn) {
    uintptr_t node =
        Memory::ReadMemory<uintptr_t>(entityPawn + Offsets::m_pGameSceneNode);  // m_pGameSceneNode
...
BoneConnection_Struct boneConnections[] = {
    ...
    BoneConnection_Struct(4, 13),  BoneConnection_Struct(13, 14),
    BoneConnection_Struct(14, 16), BoneConnection_Struct(4, 2),  // spine to spine_1
