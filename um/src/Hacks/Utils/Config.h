...
namespace Config {
    namespace Game {
        ...
        ImVec4 SpectatorColor =
            ImVec4(255.0f / 255.0f, 255.0f / 255.0f, 0.0f / 255.0f, 255.0f / 255.0f);
    ...
    namespace TriggerBot {
        ...
        const char* HotkeyOptions[] = {"Left Shift", "Left CTRL", "Left Alt", "X1_Mouse Button",
                                       "X2_Mouse Button"};
    ...
    namespace GlowHack {
        const char* AvailableColors[] = {"Green", "Yellow", "Blue", "Red",
                                         "White", "Purple", "Cyan", "LightBlue"};
    ...
    {
        inline bool enableHotKey = true;
        const char* HotkeyOptions[] = {"X2_Mouse Button", "X1_Mouse Button", "Right Mouse Button",
                                       "Left Shift",      "Left CTRL",       "Left Alt"};
        static int CurrentHotkeyIndex = 0;  // Index of the currently selected item
        int currentKey = 0x06;

        const char* AimPositions[] = {"Head", "Penis", "Neck", "Chest", "Stomach"};
