...
namespace entities {
    ...
    player_t local_player(HANDLE driver_handle, std::uintptr_t client_base, const auto localPlayer) {
        uintptr_t local_player_address = driver::read_memory<uintptr_t>(driver_handle, client_base + cs2_dumper::offsets::client_dll::dwLocalPlayerPawn);
        return player_t{local_player_address};
    }
}  // namespace entities
