    ...
    namespace schemas {
        ...
        namespace client_dll {
            ...
            namespace C_SoundEventPathCornerEntity {
                constexpr std::ptrdiff_t m_vecCornerPairsNetworked =
                    0x628;  // C_NetworkUtlVectorBase<SoundeventPathCornerPairNetworked_t>
            }
            // Parent: C_CSWeaponBaseGun
            // Field count: 0
            ...
            namespace C_BaseModelEntity {
                ...
                constexpr std::ptrdiff_t m_vecRenderAttributes =
                    0xAD8;  // C_UtlVectorEmbeddedNetworkVar<EntityRenderAttribute_t>
                ...
                constexpr std::ptrdiff_t m_ConfigEntitiesToPropagateMaterialDecalsTo =
                    0xC90;  // C_NetworkUtlVectorBase<CHandle<C_BaseModelEntity>>
            ...
            namespace C_BaseCombatCharacter {
                constexpr std::ptrdiff_t m_hMyWearables =
                    0x1118;  // C_NetworkUtlVectorBase<CHandle<C_EconWearable>>
                ...
                constexpr std::ptrdiff_t m_nWaterWakeMode =
                    0x1134;  // C_BaseCombatCharacter::WaterWakeMode_t
            ...
            namespace C_SceneEntity {
                ...
                constexpr std::ptrdiff_t m_hActorList =
                    0x580;  // C_NetworkUtlVectorBase<CHandle<C_BaseFlex>>
                constexpr std::ptrdiff_t m_bWasPlaying = 0x598;  // bool
                constexpr std::ptrdiff_t m_QueuedEvents =
                    0x5A8;  // CUtlVector<C_SceneEntity::QueuedEvents_t>
            ...
            namespace C_Inferno {
                ...
                constexpr std::ptrdiff_t m_hInfernoPointsSnapshot =
                    0xD68;  // CStrongHandle<InfoForResourceTypeIParticleSnapshot>
                constexpr std::ptrdiff_t m_hInfernoFillerPointsSnapshot =
                    0xD70;  // CStrongHandle<InfoForResourceTypeIParticleSnapshot>
                constexpr std::ptrdiff_t m_hInfernoOutlinePointsSnapshot =
                    0xD78;  // CStrongHandle<InfoForResourceTypeIParticleSnapshot>
                constexpr std::ptrdiff_t m_hInfernoClimbingOutlinePointsSnapshot =
                    0xD80;  // CStrongHandle<InfoForResourceTypeIParticleSnapshot>
                constexpr std::ptrdiff_t m_hInfernoDecalsSnapshot =
                    0xD88;  // CStrongHandle<InfoForResourceTypeIParticleSnapshot>
            ...
            namespace C_CSPlayerPawn {
                ...
                constexpr std::ptrdiff_t m_pActionTrackingServices =
                    0x1530;  // CCSPlayer_ActionTrackingServices*
                ...
                constexpr std::ptrdiff_t m_vecBulletHitModels =
                    0x2338;                                      // CUtlVector<C_BulletHitModel*>
                ...
                constexpr std::ptrdiff_t m_iBlockingUseActionInProgress =
                    0x23C4;                                           // CSPlayerBlockingUseAction_t
                ...
                constexpr std::ptrdiff_t m_PredictedDamageTags =
                    0x2490;  // C_UtlVectorEmbeddedNetworkVar<PredictedDamageTag_t>
                constexpr std::ptrdiff_t m_nPrevHighestReceivedDamageTagTick =
                    0x24E0;                                                        // GameTick_t
            ...
            namespace C_BaseCSGrenadeProjectile {
                ...
                constexpr std::ptrdiff_t m_nExplodeEffectIndex =
                    0x1188;  // CStrongHandle<InfoForResourceTypeIParticleSystemDefinition>
                ...
                constexpr std::ptrdiff_t m_nSnapshotTrajectoryEffectIndex =
                    0x11B8;  // ParticleIndex_t
                constexpr std::ptrdiff_t m_hSnapshotTrajectoryParticleSnapshot =
                    0x11C0;  // CStrongHandle<InfoForResourceTypeIParticleSnapshot>
            ...
            namespace C_PointClientUIWorldPanel {
                ...
                constexpr std::ptrdiff_t m_pOffScreenIndicator =
                    0xEF8;                                        // CPointOffScreenIndicatorUi*
                ...
                constexpr std::ptrdiff_t m_vecCSSClasses =
                    0xF50;  // C_NetworkUtlVectorBase<CUtlSymbolLarge>
            ...
            namespace C_Team {
                constexpr std::ptrdiff_t m_aPlayerControllers =
                    0x568;  // C_NetworkUtlVectorBase<CHandle<CBasePlayerController>>
                constexpr std::ptrdiff_t m_aPlayers =
                    0x580;  // C_NetworkUtlVectorBase<CHandle<C_BasePlayerPawn>>
            ...
            namespace C_TextureBasedAnimatable {
                ...
                constexpr std::ptrdiff_t m_hPositionKeys =
                    0xD28;  // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_hRotationKeys =
                    0xD30;  // CStrongHandle<InfoForResourceTypeCTextureBase>
            ...
            namespace C_EnvLightProbeVolume {
                constexpr std::ptrdiff_t m_Entity_hLightProbeTexture =
                    0x1548;  // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_Entity_hLightProbeDirectLightIndicesTexture =
                    0x1550;  // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_Entity_hLightProbeDirectLightScalarsTexture =
                    0x1558;  // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_Entity_hLightProbeDirectLightShadowsTexture =
                    0x1560;  // CStrongHandle<InfoForResourceTypeCTextureBase>
            ...
            namespace C_CSPlayerPawnBase {
                ...
                constexpr std::ptrdiff_t m_pViewModelServices =
                    0x1360;  // CPlayer_ViewModelServices*
                ...
                constexpr std::ptrdiff_t m_hOriginalController =
                    0x1500;  // CHandle<CCSPlayerController>
            }                // namespace C_CSPlayerPawnBase
            ...
            namespace C_PostProcessingVolume {
                constexpr std::ptrdiff_t m_hPostSettings =
                    0xD38;  // CStrongHandle<InfoForResourceTypeCPostProcessingResource>
            ...
            namespace CBasePlayerController {
                ...
                constexpr std::ptrdiff_t m_hSplitScreenPlayers =
                    0x640;  // CUtlVector<CHandle<CBasePlayerController>>
            ...
            namespace C_PathParticleRope {
                ...
                constexpr std::ptrdiff_t m_iEffectIndex =
                    0x5B0;  // CStrongHandle<InfoForResourceTypeIParticleSystemDefinition>
                constexpr std::ptrdiff_t m_PathNodes_Position =
                    0x5B8;  // C_NetworkUtlVectorBase<Vector>
                constexpr std::ptrdiff_t m_PathNodes_TangentIn =
                    0x5D0;  // C_NetworkUtlVectorBase<Vector>
                constexpr std::ptrdiff_t m_PathNodes_TangentOut =
                    0x5E8;  // C_NetworkUtlVectorBase<Vector>
                constexpr std::ptrdiff_t m_PathNodes_Color =
                    0x600;  // C_NetworkUtlVectorBase<Vector>
                constexpr std::ptrdiff_t m_PathNodes_PinEnabled =
                    0x618;  // C_NetworkUtlVectorBase<bool>
                constexpr std::ptrdiff_t m_PathNodes_RadiusScale =
                    0x630;  // C_NetworkUtlVectorBase<float32>
            }               // namespace C_PathParticleRope
            // Parent: None
            // Field count: 0
            //
            ...
            namespace CBasePlayerWeaponVData {
                ...
                constexpr std::ptrdiff_t m_sToolsOnlyOwnerModelName =
                    0x108;  // CResourceNameTyped<CWeakHandle<InfoForResourceTypeCModel>>
                constexpr std::ptrdiff_t m_bBuiltRightHanded = 0x1E8;  // bool
                constexpr std::ptrdiff_t m_bAllowFlipping = 0x1E9;     // bool
                constexpr std::ptrdiff_t m_sMuzzleAttachment =
                    0x1F0;  // CAttachmentNameSymbolWithStorage
                constexpr std::ptrdiff_t m_szMuzzleFlashParticle =
                    0x210;  // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
                ...
                constexpr std::ptrdiff_t m_aShootSounds =
                    0x320;  // CUtlOrderedMap<WeaponSound_t,CSoundEventName>
            }               // namespace CBasePlayerWeaponVData
            // Parent: CBaseAnimGraph
            // Field count: 23
            //
            ...
            namespace C_BasePlayerPawn {
                ...
                constexpr std::ptrdiff_t m_pFlashlightServices =
                    0x11D0;                                           // CPlayer_FlashlightServices*
                ...
                constexpr std::ptrdiff_t m_ServerViewAngleChanges =
                    0x11F0;  // C_UtlVectorEmbeddedNetworkVar<ViewAngleServerChange_t>
            ...
            namespace C_RopeKeyframe {
                ...
                constexpr std::ptrdiff_t m_iRopeMaterialModelIndex =
                    0xD68;  // CStrongHandle<InfoForResourceTypeIMaterial2>
                ...
                constexpr std::ptrdiff_t m_PhysicsDelegate =
                    0x1078;  // C_RopeKeyframe::CPhysicsDelegate
                constexpr std::ptrdiff_t m_hMaterial =
                    0x1088;  // CStrongHandle<InfoForResourceTypeIMaterial2>
            ...
            namespace C_GradientFog {
                constexpr std::ptrdiff_t m_hGradientFogTexture =
                    0x568;  // CStrongHandle<InfoForResourceTypeCTextureBase>
            ...
            namespace C_EnvCombinedLightProbeVolume {
                ...
                constexpr std::ptrdiff_t m_Entity_hCubemapTexture =
                    0x15D0;  // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_Entity_bCustomCubemapTexture = 0x15D8;  // bool
                constexpr std::ptrdiff_t m_Entity_hLightProbeTexture =
                    0x15E0;  // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_Entity_hLightProbeDirectLightIndicesTexture =
                    0x15E8;  // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_Entity_hLightProbeDirectLightScalarsTexture =
                    0x15F0;  // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_Entity_hLightProbeDirectLightShadowsTexture =
                    0x15F8;  // CStrongHandle<InfoForResourceTypeCTextureBase>
            ...
            namespace C_BarnLight {
                ...
                constexpr std::ptrdiff_t m_QueuedLightStyleStrings =
                    0xD60;  // C_NetworkUtlVectorBase<CUtlString>
                constexpr std::ptrdiff_t m_LightStyleEvents =
                    0xD78;  // C_NetworkUtlVectorBase<CUtlString>
                constexpr std::ptrdiff_t m_LightStyleTargets =
                    0xD90;  // C_NetworkUtlVectorBase<CHandle<C_BaseModelEntity>>
                constexpr std::ptrdiff_t m_StyleEvent = 0xDA8;  // CEntityIOOutput[4]
                constexpr std::ptrdiff_t m_hLightCookie =
                    0xE48;  // CStrongHandle<InfoForResourceTypeCTextureBase>
            ...
            namespace C_EconEntity {
                ...
                constexpr std::ptrdiff_t m_vecAttachedModels =
                    0x1648;  // CUtlVector<C_EconEntity::AttachedModelData_t>
            }                // namespace C_EconEntity
            // Parent: C_CSWeaponBaseGun
            // Field count: 0
            ...
            namespace C_ParticleSystem {
                ...
                constexpr std::ptrdiff_t m_iEffectIndex =
                    0xF30;  // CStrongHandle<InfoForResourceTypeIParticleSystemDefinition>
            ...
            namespace C_EnvDecal {
                constexpr std::ptrdiff_t m_hDecalMaterial =
                    0xD20;  // CStrongHandle<InfoForResourceTypeIMaterial2>
            ...
            namespace CCSGameModeRules_ArmsRace {
                constexpr std::ptrdiff_t m_WeaponSequence =
                    0x30;  // C_NetworkUtlVectorBase<CUtlString>
            }
            // Parent: C_PointEntity
            // Field count: 1
            namespace CPointChildModifier {
                constexpr std::ptrdiff_t m_bOrphanInsteadOfDeletingChildrenOnRemove =
                    0x568;  // bool
            }
            // Parent: None
            // Field count: 15
            ...
            namespace CLightComponent {
                ...
                constexpr std::ptrdiff_t m_hLightCookie =
                    0xA8;  // CStrongHandle<InfoForResourceTypeCTextureBase>
            ...
            namespace C_EnvParticleGlow {
                ...
                constexpr std::ptrdiff_t m_hTextureOverride =
                    0x12E0;  // CStrongHandle<InfoForResourceTypeCTextureBase>
            }                // namespace C_EnvParticleGlow
            // Parent: C_BaseEntity
            // Field count: 15
            ...
            namespace C_FuncLadder {
                ...
                constexpr std::ptrdiff_t m_Dismounts =
                    0xD30;  // CUtlVector<CHandle<C_InfoLadderDismount>>
            ...
            namespace C_EnvVolumetricFogController {
                ...
                constexpr std::ptrdiff_t m_hFogIndirectTexture =
                    0x5E0;  // CStrongHandle<InfoForResourceTypeCTextureBase>
            ...
            namespace CBuoyancyHelper {
                ...
                constexpr std::ptrdiff_t m_vecFractionOfWheelSubmergedForWheelFriction =
                    0x20;                                                  // CUtlVector<float32>
                constexpr std::ptrdiff_t m_vecWheelFrictionScales = 0x38;  // CUtlVector<float32>
                constexpr std::ptrdiff_t m_vecFractionOfWheelSubmergedForWheelDrag =
                    0x50;                                        // CUtlVector<float32>
            ...
            namespace shard_model_desc_t {
                ...
                constexpr std::ptrdiff_t m_hMaterialBase =
                    0x10;  // CStrongHandle<InfoForResourceTypeIMaterial2>
                constexpr std::ptrdiff_t m_hMaterialDamageOverlay =
                    0x18;  // CStrongHandle<InfoForResourceTypeIMaterial2>
                ...
                constexpr std::ptrdiff_t m_vecPanelVertices =
                    0x40;  // C_NetworkUtlVectorBase<Vector2D>
                constexpr std::ptrdiff_t m_vInitialPanelVertices =
                    0x58;  // C_NetworkUtlVectorBase<Vector4D>
            ...
            namespace C_EnvCubemap {
                constexpr std::ptrdiff_t m_Entity_hCubemapTexture =
                    0x5E8;  // CStrongHandle<InfoForResourceTypeCTextureBase>
            ...
            namespace C_PointValueRemapper {
                ...
                constexpr std::ptrdiff_t m_hOutputEntities =
                    0x590;  // C_NetworkUtlVectorBase<CHandle<C_BaseEntity>>
            ...
            namespace C_PlayerSprayDecal {
                ...
                constexpr std::ptrdiff_t m_SprayRenderHelper =
                    0xE00;  // CPlayerSprayDecalRenderHelper
            }               // namespace C_PlayerSprayDecal
            // Parent: None
            // Field count: 2
            //
            ...
            namespace C_EnvSky {
                ...
                constexpr std::ptrdiff_t m_hSkyMaterialLightingOnly =
                    0xD28;  // CStrongHandle<InfoForResourceTypeIMaterial2>
            ...
            namespace CInfoOffscreenPanoramaTexture {
                ...
                constexpr std::ptrdiff_t m_TargetEntities =
                    0x588;  // C_NetworkUtlVectorBase<CHandle<C_BaseModelEntity>>
                constexpr std::ptrdiff_t m_nTargetChangeCount = 0x5A0;  // int32
                constexpr std::ptrdiff_t m_vecCSSClasses =
                    0x5A8;  // C_NetworkUtlVectorBase<CUtlSymbolLarge>
            ...
            namespace C_BreakableProp {
                ...
                constexpr std::ptrdiff_t m_OnHealthChanged =
                    0x1028;                                        // CEntityOutputTemplate<float32>
                ...
                constexpr std::ptrdiff_t m_BreakableContentsType =
                    0x10A0;  // BreakableContentsType_t
                constexpr std::ptrdiff_t m_strBreakableContentsPropGroupOverride =
                    0x10A8;  // CUtlString
            ...
            namespace C_Beam {
                ...
                constexpr std::ptrdiff_t m_hBaseMaterial =
                    0xD58;  // CStrongHandle<InfoForResourceTypeIMaterial2>
                constexpr std::ptrdiff_t m_nHaloIndex =
                    0xD60;  // CStrongHandle<InfoForResourceTypeIMaterial2>
            ...
            namespace CCSWeaponBaseVData {
                ...
                constexpr std::ptrdiff_t m_szViewModel =
                    0x350;  // CResourceNameTyped<CWeakHandle<InfoForResourceTypeCModel>>
                constexpr std::ptrdiff_t m_szPlayerModel =
                    0x430;  // CResourceNameTyped<CWeakHandle<InfoForResourceTypeCModel>>
                constexpr std::ptrdiff_t m_szWorldDroppedModel =
                    0x510;  // CResourceNameTyped<CWeakHandle<InfoForResourceTypeCModel>>
                constexpr std::ptrdiff_t m_szAimsightLensMaskModel =
                    0x5F0;  // CResourceNameTyped<CWeakHandle<InfoForResourceTypeCModel>>
                constexpr std::ptrdiff_t m_szMagazineModel =
                    0x6D0;  // CResourceNameTyped<CWeakHandle<InfoForResourceTypeCModel>>
                constexpr std::ptrdiff_t m_szHeatEffect =
                    0x7B0;  // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
                constexpr std::ptrdiff_t m_szEjectBrassEffect =
                    0x890;  // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
                constexpr std::ptrdiff_t m_szMuzzleFlashParticleAlt =
                    0x970;  // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
                constexpr std::ptrdiff_t m_szMuzzleFlashThirdPersonParticle =
                    0xA50;  // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
                constexpr std::ptrdiff_t m_szMuzzleFlashThirdPersonParticleAlt =
                    0xB30;  // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
                constexpr std::ptrdiff_t m_szTracerParticle =
                    0xC10;  // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
            ...
            namespace C_PointWorldText {
                ...
                constexpr std::ptrdiff_t m_nJustifyHorizontal =
                    0xF8C;  // PointWorldTextJustifyHorizontal_t
                constexpr std::ptrdiff_t m_nJustifyVertical =
                    0xF90;  // PointWorldTextJustifyVertical_t
            ...
            namespace CCSPlayerController {
                constexpr std::ptrdiff_t m_pInGameMoneyServices =
                    0x720;  // CCSPlayerController_InGameMoneyServices*
                constexpr std::ptrdiff_t m_pInventoryServices =
                    0x728;  // CCSPlayerController_InventoryServices*
                constexpr std::ptrdiff_t m_pActionTrackingServices =
                    0x730;  // CCSPlayerController_ActionTrackingServices*
            ...
            namespace C_PhysMagnet {
                ...
                constexpr std::ptrdiff_t m_aAttachedObjects =
                    0xF98;  // CUtlVector<CHandle<C_BaseEntity>>
            }               // namespace C_PhysMagnet
            // Parent: C_BaseModelEntity
            // Field count: 8
            //
            ...
            namespace C_FuncConveyor {
                ...
                constexpr std::ptrdiff_t m_hConveyorModels =
                    0xD48;  // C_NetworkUtlVectorBase<CHandle<C_BaseEntity>>
            ...
            namespace CGameSceneNode {
                ...
                constexpr std::ptrdiff_t m_vecOrigin =
                    0x88;  // CNetworkOriginCellCoordQuantizedVector
            ...
            namespace C_Sprite {
                ...
                constexpr std::ptrdiff_t m_hOldSpriteMaterial =
                    0xD88;  // CWeakHandle<InfoForResourceTypeIMaterial2>
